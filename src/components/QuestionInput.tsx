    ...
    <div className="border-t border-white/[0.08] bg-black/80 backdrop-blur-xl p-4 sm:p-5 sticky bottom-0 z-30 transition-colors">
      <div className="max-w-4xl mx-auto space-y-2.5">
        ...
        {isRecording || isTranscribing ? (
          <div className="flex items-center justify-between p-3 sm:p-3.5 rounded-full border border-rose-500/40 bg-rose-950/20 backdrop-blur-xl shadow-[0_0_25px_rgba(244,63,94,0.15)] animate-fade-in">
            ...
            <div className="flex items-center gap-2 pr-1">
              ...
              <button
                ...
                disabled={isTranscribing}
                className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-rose-500 hover:bg-rose-600 text-white text-xs font-semibold shadow-lg transition-all tactile-btn"
              >
                {isTranscribing ? (
                  <>
